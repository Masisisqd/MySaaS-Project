...
// ─── Risk Factor Queries ───────────────────────────────────────────────────
async function getRiskFactors(companyId, ceoId, familyId) {
...
function buildBoardAlertEmail(companyName, childName, score, riskFactors, dashboardUrl) {
    return `
<!DOCTYPE html>
<html lang="en">
...
function buildCEORecoveryEmail(companyName, childName, score) {
    return `
<!DOCTYPE html>
<html lang="en">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"></head>
...
async function sendRiskAlertEmails(companyId, companyName, ceoId, familyId, newScore, riskFactors) {
    ...
    const parentEmail = familyData === null || familyData === void 0 ? void 0 : familyData.parentEmail;
    if (!parentEmail) {
    ...
    const childName = (ceoData === null || ceoData === void 0 ? void 0 : ceoData.name) || "CEO";
    const childEmail = ceoData === null || ceoData === void 0 ? void 0 : ceoData.email;
